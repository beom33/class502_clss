...
public class Ex02Test {
    ...
    void init() {
        ...
        // 스텁(Stub) 추가
        given(request.getParameter("email")).willReturn(faker.internet()
                .emailAddress());
        given(request.getParameter("password")).willReturn(faker
                .regexify("\\w{8}").toLowerCase());
    }
    ...
    void test2() {
        ...
        String usedEmail= captor.getValue(); // send 메서드에서 매개변술 사용 한 값
